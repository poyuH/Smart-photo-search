...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://dxp9iwedk9.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['item', 'folder', 'Content-Type'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['item', 'folder', ]),
            body: body
        };
